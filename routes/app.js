 ...
 router.put("/guitar/cart/remove/quantity/:id", (req, res) => {
  ...
  if (isInCart && shoppingCart[cartIndex].qty != 0) {
    if (shoppingCart[cartIndex].qty > 1 ) {
      ...
      res.json("The quantity will be empty, it is cannot removed");
  }
 }
 })


//delete items in a cart if quantity is 0
router.delete("/guitar/quantity/:id", (req, res) => {
